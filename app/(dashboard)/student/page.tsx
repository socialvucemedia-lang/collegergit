        ...
        <div className="space-y-6">
            <Card className="p-6 bg-neutral-900 text-white dark:bg-white dark:text-black">
                <div className="flex justify-between items-start">
                    ...
                    <Badge className="bg-white/20 text-white hover:bg-white/30 dark:bg-black/10 dark:text-black dark:hover:bg-black/20 border-none">
                        Compliant
                    </Badge>
                </div>
                <div className="mt-4 h-2 bg-white/20 dark:bg-black/10 rounded-full overflow-hidden">
                    <div className="h-full bg-white dark:bg-black w-[82%]" />
                </div>
            </Card>

            <div className="grid grid-cols-2 gap-3">
                <Card className="p-4 border-l-4 border-l-green-500">
                    <p className="text-xs text-neutral-500 mb-1">Eng. Graphics</p>
                    <p className="text-xl font-bold">94%</p>
                </Card>
                <Card className="p-4 border-l-4 border-l-green-500">
                    <p className="text-xs text-neutral-500 mb-1">AM-II</p>
                    <p className="text-xl font-bold">88%</p>
                </Card>
                <Card className="p-4 border-l-4 border-l-yellow-500">
                    <p className="text-xs text-neutral-500 mb-1">Data Structures</p>
                    <p className="text-xl font-bold">78%</p>
                </Card>
                <Card className="p-4 border-l-4 border-l-red-500">
                    <p className="text-xs text-neutral-500 mb-1">Physics (EP)</p>
