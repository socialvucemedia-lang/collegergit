...
import { GraduationCap, Users, ClipboardList, Calendar, Bell, LogOut, FileText } from 'lucide-react';
...
export default function TeacherLayout({
    ...
    return (
        <ProtectedRoute requiredRole="teacher">
            <div className={`min-h-screen bg-neutral-50 dark:bg-neutral-950 ${isAttendancePage ? '' : 'pb-24'}`}>
                ...
                <main className={isAttendancePage ? "" : "pt-20 px-4 max-w-lg mx-auto"}>
                    {children}
                </main>
